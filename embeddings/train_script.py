...
# Script was called via:
#python train_many_data_files_v2.py --steps 1000000 --batch_size 128 --model nreimers/MiniLM-L6-H384-uncased train_data_configs/all_datasets_v3.json output/all_datasets_v3_MiniLM-L6-H384-uncased-batch128